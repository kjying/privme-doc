...
##### HTTP Method: POST
##### URL: https://host/app/user/bank_edit.php
...
bank_name     | string| 银行名称 |true|
bank_num     | string| 银行卡账号 |true|
bank_province     | string| 开户省/市 |true|
bank_city     | string| 开户地区 |true|
phone_code     | string| 手机验证码 |true|
